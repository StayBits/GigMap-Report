...
| EP08    | Implementación de M1AU: Chatbot Inteligente | Esta épica abarca la creación del modelo, su integración con el backend, la conexión con los endpoints de conciertos y la implementación de la interfaz conversacional dentro de la aplicación móvil, garantizando una experiencia intuitiva, fluida y altamente interactiva para los usuarios. |
  ...
  <tbody>
    ...
    <tr>
      <td colspan="4">
		...
		Entonces se crea la comunidad y queda visible para otros usuarios.<br>
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td colspan="4">
        <strong>Escenario: Creación de comunidad oficial</strong><br>
		Dado que el artista inicia sesión en su cuenta verificada<br>
		Cuando crea una nueva comunidad en GigMap<br>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td colspan="4">
        <strong>Escenario: Seguir a un usuario exitosamente</strong><br>
        Dado que estoy autenticado en la aplicación<br>
        Y estoy en el perfil de otro usuario<br>
        Cuando hago touch en el botón "Seguir"<br>
        Entonces el sistema muestra que ahora sigo a ese usuario<br>
...
<table> <thead> <tr> <th>Story ID</th> <th>User</th> <th>Priority</th> <th>Epic</th> </tr> </thead> <tbody> <tr> <td>US42</td> <td>Usuario</td> <td>1</td> <td>EP08</td> </tr> <tr> <td><strong>Title</strong></td> <td colspan="3">Acceso a un asistente conversacional</td> </tr> <tr> <td colspan="4"><strong>Description</strong></td> </tr> <tr> <td colspan="4">Como usuario de GigMap, quiero contar con un asistente virtual que me ayude a navegar y encontrar información rápidamente para mejorar mi experiencia.</td> </tr> <tr> <td colspan="4"><strong>Acceptance Criteria</strong></td> </tr> <tr> <td colspan="4"> <strong>Escenario: Interacción inicial con M1AU</strong><br> Dado que el usuario abre el chatbot<br> Cuando escribe su primera consulta<br> Entonces M1AU responde con opciones y asistencias relevantes.<br><br> <strong>Escenario: Navegación asistida</strong><br> Dado que el usuario necesita encontrar una sección<br> Cuando solicita ayuda a M1AU<br> Entonces el asistente lo guía o lo redirige correctamente. </td> </tr> </tbody> </table>
<table> <thead> <tr> <th>Story ID</th> <th>User</th> <th>Priority</th> <th>Epic</th> </tr> </thead> <tbody> <tr> <td>US43</td> <td>Usuario</td> <td>1</td> <td>EP08</td> </tr> <tr> <td><strong>Title</strong></td> <td colspan="3">Filtrar conciertos por artista mediante el chatbot</td> </tr> <tr> <td colspan="4"><strong>Description</strong></td> </tr> <tr> <td colspan="4">Como usuario, quiero poder escribirle a M1AU el nombre de un artista para que me muestre los conciertos disponibles de dicho artista.</td> </tr> <tr> <td colspan="4"><strong>Acceptance Criteria</strong></td> </tr> <tr> <td colspan="4"> <strong>Escenario: Solicitud por artista</strong><br> Dado que el usuario busca un artista específico<br> Cuando escribe “muéstrame conciertos de X”<br> Entonces M1AU retorna la lista de conciertos relacionados.<br><br> <strong>Escenario: Respuesta informativa</strong><br> Dado que M1AU encuentra resultados<br> Cuando responde<br> Entonces incluye nombre del concierto, fecha, y acceso al detalle. </td> </tr> </tbody> </table>
<table> <thead> <tr> <th>Story ID</th> <th>User</th> <th>Priority</th> <th>Epic</th> </tr> </thead> <tbody> <tr> <td>US44</td> <td>Usuario</td> <td>1</td> <td>EP08</td> </tr> <tr> <td><strong>Title</strong></td> <td colspan="3">Filtrar conciertos por fecha mediante el chatbot</td> </tr> <tr> <td colspan="4"><strong>Description</strong></td> </tr> <tr> <td colspan="4">Como usuario, quiero poder pedirle a M1AU conciertos para una fecha específica para encontrar eventos que coincidan con mis planes.</td> </tr> <tr> <td colspan="4"><strong>Acceptance Criteria</strong></td> </tr> <tr> <td colspan="4"> <strong>Escenario: Consulta por fecha</strong><br> Dado que el usuario busca un día específico<br> Cuando escribe “quiero un concierto el 10 de diciembre”<br> Entonces M1AU muestra los conciertos programados ese día.<br><br> <strong>Escenario: Múltiples coincidencias</strong><br> Dado que existen varios conciertos ese día<br> Cuando M1AU responde<br> Entonces presenta la lista completa de opciones. </td> </tr> </tbody> </table>
<table> <thead> <tr> <th>Story ID</th> <th>User</th> <th>Priority</th> <th>Epic</th> </tr> </thead> <tbody> <tr> <td>US45</td> <td>Usuario</td> <td>1</td> <td>EP08</td> </tr> <tr> <td><strong>Title</strong></td> <td colspan="3">Filtrar conciertos por plataforma mediante el chatbot</td> </tr> <tr> <td colspan="4"><strong>Description</strong></td> </tr> <tr> <td colspan="4">Como usuario, quiero poder pedir conciertos según su plataforma de venta (como Teleticket o Joinnus) para ver solo los eventos de mi preferencia.</td> </tr> <tr> <td colspan="4"><strong>Acceptance Criteria</strong></td> </tr> <tr> <td colspan="4"> <strong>Escenario: Consulta por plataforma</strong><br> Dado que el usuario prefiere una plataforma<br> Cuando dice “muéstrame conciertos de Teleticket”<br> Entonces M1AU retorna solo los conciertos disponibles en esa plataforma.<br><br> <strong>Escenario: Plataforma sin resultados</strong><br> Dado que no existen conciertos en esa plataforma<br> Cuando M1AU responde<br> Entonces informa al usuario que no hay resultados disponibles. </td> </tr> </tbody> </table>
<table> <thead> <tr> <th>Story ID</th> <th>User</th> <th>Priority</th> <th>Epic</th> </tr> </thead> <tbody> <tr> <td>US46</td> <td>Usuario</td> <td>2</td> <td>EP08</td> </tr> <tr> <td><strong>Title</strong></td> <td colspan="3">Comprensión de lenguaje natural</td> </tr> <tr> <td colspan="4"><strong>Description</strong></td> </tr> <tr> <td colspan="4">Como usuario, quiero que M1AU entienda frases naturales y no solo comandos específicos para conversar de forma más fluida.</td> </tr> <tr> <td colspan="4"><strong>Acceptance Criteria</strong></td> </tr> <tr> <td colspan="4"> <strong>Escenario: Lenguaje coloquial</strong><br> Dado que el usuario escribe de forma natural<br> Cuando dice frases como “oye, ¿qué conciertos hay mañana?”<br> Entonces M1AU interpreta correctamente y responde con información relevante.<br><br> <strong>Escenario: Reformulación</strong><br> Dado que M1AU no entiende una frase<br> Cuando lo indica al usuario<br> Entonces sugiere alternativas para reformular la consulta. </td> </tr> </tbody> </table>
<table> <thead> <tr> <th>Story ID</th> <th>User</th> <th>Priority</th> <th>Epic</th> </tr> </thead> <tbody> <tr> <td>US47</td> <td>Usuario</td> <td>2</td> <td>EP08</td> </tr> <tr> <td><strong>Title</strong></td> <td colspan="3">Acceso rápido desde las respuestas del chatbot</td> </tr> <tr> <td colspan="4"><strong>Description</strong></td> </tr> <tr> <td colspan="4">Como usuario, quiero que M1AU incluya enlaces o botones a conciertos para acceder rápidamente al detalle del evento desde la conversación.</td> </tr> <tr> <td colspan="4"><strong>Acceptance Criteria</strong></td> </tr> <tr> <td colspan="4"> <strong>Escenario: Acceso directo</strong><br> Dado que M1AU muestra un concierto<br> Cuando incluye un botón o enlace<br> Entonces el usuario puede abrir la vista del concierto con un solo toque.<br><br> <strong>Escenario: Navegación fluida</strong><br> Dado que el usuario interactúa con resultados del chatbot<br> Cuando selecciona un concierto<br> Entonces la app lo lleva inmediatamente a su ficha informativa. </td> </tr> </tbody> </table>
<table> <thead> <tr> <th>Story ID</th> <th>User</th> <th>Priority</th> <th>Epic</th> </tr> </thead> <tbody> <tr> <td>US48</td> <td>Usuario</td> <td>3</td> <td>EP08</td> </tr> <tr> <td><strong>Title</strong></td> <td colspan="3">Respuestas rápidas y dinámicas</td> </tr> <tr> <td colspan="4"><strong>Description</strong></td> </tr> <tr> <td colspan="4">Como usuario, quiero que M1AU responda rápidamente para mantener una conversación fluida y eficiente.</td> </tr> <tr> <td colspan="4"><strong>Acceptance Criteria</strong></td> </tr> <tr> <td colspan="4"> <strong>Escenario: Tiempo de respuesta</strong><br> Dado que el usuario hace una consulta<br> Cuando M1AU procesa la información<br> Entonces responde en menos de 2 segundos.<br><br> <strong>Escenario: Fluidez conversacional</strong><br> Dado que el usuario envía múltiples mensajes<br> Cuando M1AU responde<br> Entonces no se generan esperas prolongadas ni interrupciones. </td> </tr> </tbody> </table>
...
| TS-02    | Endpoint para obtener eventos por ubicación    | Como developer, quiero un endpoint GET que devuelva eventos cerca de una lat/lon            | **Escenario: Consulta exitosa por lat/lon (GET)**<br>Dado que el usuario envía lat/lon como query params<br>Cuando hay eventos cercanos<br>Entonces devuelve una lista de eventos georreferenciados<br><br>**Escenario: Consulta sin resultados**<br>Dado que no hay eventos en la zona<br>Cuando se hace la petición<br>Entonces el servidor responde con lista vacía                              | EP06               |
| TS-03    | Endpoint para registrar asistencia             | Como developer, quiero que los usuarios puedan confirmar asistencia a eventos               | **Escenario: Confirmación registrada**<br>Dado que el usuario hace clic en "Asistiré"<br>Cuando se envía el POST<br>Entonces se actualiza el conteo en la base de datos<br><br>**Escenario: Asistencia ya registrada**<br>Dado que el usuario ya marcó su asistencia<br>Cuando intenta hacerlo otra vez<br>Entonces se impide duplicar el registro                                                  | EP06               |
| TS-04    | Endpoint para valorar un evento                | Como developer, quiero permitir que el usuario envíe una calificación y comentario          | **Escenario: Envío de valoración válida**<br>Dado que el evento ya ocurrió<br>Cuando el usuario hace un POST con la valoración<br>Entonces se guarda y actualiza el perfil del evento<br><br>**Escenario: Prevención de múltiples valoraciones**<br>Dado que el usuario ya valoró<br>Cuando lo intenta de nuevo<br>Entonces se actualiza o da error                                                 | EP06               |
...
| TS-06    | Endpoint para crear publicaciones en comunidad | Como developer, quiero permitir que un usuario cree publicaciones en comunidades            | **Escenario: Publicación creada**<br>Dado que el usuario está en una comunidad<br>Cuando hace un POST con el mensaje y/o imagen<br>Entonces se guarda correctamente y aparece en el feed<br><br>**Escenario: Validación de campos**<br>Cuando falta el contenido mínimo<br>Entonces se devuelve un error con código 400                                                                             | EP06               |
| TS-07    | Endpoint para reaccionar a publicaciones       | Como developer, quiero permitir agregar reacciones a publicaciones de comunidad             | **Escenario: Reacción registrada**<br>Dado que el usuario está autenticado<br>Cuando da clic en una reacción<br>Entonces se actualiza el conteo en la base de datos<br><br>**Escenario: Reacción duplicada**<br>Dado que ya reaccionó<br>Cuando intenta hacer lo mismo<br>Entonces se actualiza o se revierte la reacción previa                                                                    |  EP06               |
| TS-8    | Endpoint para listar comunidades de usuario    | Como developer, quiero obtener las comunidades a las que un usuario pertenece               | **Escenario: Listado de comunidades**<br>Dado que el usuario está logueado<br>Cuando hace una petición GET a /api/users/{id}/communities<br>Entonces recibe la lista de comunidades donde está unido                                                                                                                                                                                                |  EP06               |
...
| TS-10    | Endpoint para ver perfiles públicos            | Como developer, quiero permitir ver el perfil público de otros usuarios                     | **Escenario: Acceso a perfil público**<br>Dado que un usuario hace clic en otro<br>Cuando accede a /api/users/{id}<br>Entonces ve nombre, foto y comunidades visibles                                                                                                                                                                                                                               | EP06               |
| TS-11    | Endpoint para subir imágenes a publicaciones   | Como developer, quiero permitir que los usuarios suban imágenes en publicaciones            | **Escenario: Imagen aceptada**<br>Dado que el usuario adjunta una imagen al crear publicación<br>Cuando el archivo es válido<br>Entonces se guarda y muestra en el frontend<br><br>**Escenario: Archivo inválido**<br>Cuando sube un archivo no permitido<br>Entonces se devuelve un error con código y mensaje                                                                                     |  EP06               |
...
| TS-13    | Endpoint para login seguro               | Como developer, quiero un endpoint POST para permitir el login con verificación de contraseña encriptada | **Escenario: Login exitoso**<br>Dado que el usuario ya está registrado<br>Cuando hace POST a /api/authentication/sign-up con las credenciales correctas<br>Entonces recibe un token de autenticación JWT<br><br>**Escenario: Credenciales inválidas**<br>Dado que los datos son incorrectos<br>Cuando intenta loguearse<br>Entonces se devuelve un error 401 con mensaje adecuado                         | EP06               |
| TS-14 | Endpoint para obtener todos los conciertos | Como developer, quiero un endpoint GET en /api/v1/concerts/list que devuelva todos los conciertos públicos para mostrarlos en la sección de exploración de conciertos. | **Escenario: Lista de conciertos pública**<br>Dado que el usuario visita la página principal<br>Cuando se llama a /api/v1/concerts/list<br>Entonces se devuelve una lista con los conciertos disponibles | EP06 |
| TS-15 | Confirmar asistencia a concierto | Como developer, quiero un endpoint POST en /api/v1/concerts/{concertId}/attend para que los usuarios puedan confirmar su asistencia a un concierto. | **Escenario: Asistencia confirmada**<br>Dado que el usuario da clic en "Asistiré"<br>Cuando se hace POST al endpoint<br>Entonces se registra su asistencia en la base de datos |  EP06 |
| TS-16 | Cancelar asistencia a concierto | Como developer, quiero un endpoint DELETE en /api/v1/concerts/{concertId}/attend para que los usuarios puedan cancelar su asistencia. | **Escenario: Asistencia cancelada**<br>Dado que el usuario ya está registrado en un concierto<br>Cuando hace DELETE al endpoint<br>Entonces se elimina su asistencia del registro |  EP06 |
| TS-17 | Obtener comunidades | Como developer, quiero un endpoint GET en /api/v1/communities que devuelva todas las comunidades disponibles para unirse. | **Escenario: Listado de comunidades**<br>Dado que el usuario está en la vista de comunidades<br>Cuando hace una petición GET<br>Entonces recibe la lista completa de comunidades |  EP06 |
| TS-18 | Unirse a una comunidad | Como developer, quiero un endpoint POST en /api/v1/communities/{communityId}/join que permita a los usuarios unirse a una comunidad. | **Escenario: Unión a comunidad**<br>Dado que el usuario desea unirse<br>Cuando hace POST al endpoint<br>Entonces queda registrado como miembro de la comunidad |  EP06 |
| TS-19 | Salir de una comunidad | Como developer, quiero un endpoint DELETE en /api/v1/communities/{communityId}/join para permitir que los usuarios abandonen una comunidad. | **Escenario: Salida de comunidad**<br>Dado que el usuario ya pertenece a una comunidad<br>Cuando hace DELETE al endpoint<br>Entonces se elimina su membresía | EP06 |
| TS-20 | Crear concierto | Como developer, quiero un endpoint POST en /api/v1/concerts para registrar un nuevo concierto en la base de datos. | **Escenario: Creación exitosa de evento**<br>Dado que el usuario envía un body válido<br>Cuando se realiza el POST<br>Entonces se registra el concierto y se devuelve un 201 | EP06 |
| TS-21 | Obtener concierto por ID | Como developer, quiero un endpoint GET en /api/v1/concerts/{id} que devuelva los datos de un concierto específico. | **Escenario: Consulta de evento existente**<br>Dado que el ID es válido<br>Cuando se llama al endpoint<br>Entonces se devuelven los datos del concierto |  EP06 |
| TS-22 | Eliminar concierto por ID | Como developer, quiero un endpoint DELETE en /api/v1/concerts/{id} que permita eliminar un concierto de la base de datos. | **Escenario: Eliminación de concierto**<br>Dado que el concierto existe<br>Cuando se hace DELETE<br>Entonces el evento se elimina correctamente | EP06 |
| TS-23 | Toggle asistencia a concierto | Como developer, quiero un endpoint POST en /api/v1/concerts/{concertId}/toggle-attendance para alternar asistencia de un usuario a un concierto. | **Escenario: Alternancia de estado**<br>Dado que el usuario no ha asistido<br>Cuando llama al endpoint<br>Entonces se registra su asistencia<br>**Escenario 2: Ya asistió**<br>Dado que el usuario ya había confirmado<br>Cuando vuelve a llamar<br>Entonces se elimina su asistencia del registro |  EP06 |
| TS-24 | Cambiar estado de concierto | Como developer, quiero un endpoint PUT en /api/v1/concerts/{id}/status que permita actualizar el estado del concierto (activo, cancelado, etc.). | **Escenario: Estado actualizado**<br>Dado que el usuario es organizador<br>Cuando hace el PUT<br>Entonces se guarda el nuevo estado del evento | EP06 |
...
| TS-32 | Ver publicación por ID | Como developer, quiero un endpoint GET en /api/v1/post/{id} para obtener el detalle de una publicación. | **Escenario: Consulta de publicación**<br>Dado que el ID es válido<br>Cuando se hace GET<br>Entonces se devuelven los detalles | EP06 |
| TS-33 | Eliminar publicación por ID | Como developer, quiero un endpoint DELETE en /api/v1/post/{id} para permitir que un usuario borre su publicación. | **Escenario: Eliminación exitosa**<br>Dado que es el autor<br>Cuando hace DELETE<br>Entonces el post se elimina | EP06 |
| TS-34 | Ver publicaciones por comunidad | Como developer, quiero un endpoint GET en /api/v1/post/by-community/{communityId} que liste todas las publicaciones de una comunidad. | **Escenario: Listado por comunidad**<br>Dado que el usuario accede a una comunidad<br>Cuando hace GET<br>Entonces se muestran sus publicaciones | EP06 |
| TS-35 | Registro de usuario | Como developer, quiero un endpoint POST en /api/v1/authentication/sign-up para registrar nuevos usuarios con contraseña encriptada. | **Escenario: Registro exitoso**<br>Dado que el usuario envía datos válidos<br>Cuando se hace POST<br>Entonces se guarda y se aplica hashing (bcrypt)<br>**Escenario: Email duplicado**<br>Dado que el correo ya existe<br>Cuando se intenta registrar<br>Entonces el servidor responde 409 |  EP06 |
| TS-36 | Login de usuario | Como developer, quiero un endpoint POST en /api/v1/authentication/sign-in que permita iniciar sesión con validación de credenciales. | **Escenario: Login exitoso**<br>Dado que los datos son correctos<br>Cuando hace POST<br>Entonces se retorna un JWT<br>**Escenario: Fallo de autenticación**<br>Dado que las credenciales no son válidas<br>Entonces retorna error 401 | EP06 |
| TS-37    | Endpoint para enviar mensaje a M1AU            | Como developer, quiero un endpoint POST /postchat que reciba el mensaje del usuario y devuelva la respuesta generada por el modelo. | **Escenario: Envío correcto de mensaje**<br>Dado que el cliente envía un POST a /postchat con un body {“message”: “...”}<br>Cuando el mensaje es válido<br>Entonces el servidor responde 200 con una respuesta JSON del chatbot.<br><br>**Escenario: Error por cuerpo inválido**<br>Dado un body vacío<br>Cuando el servidor lo valida<br>Entonces responde 400 indicando formato incorrecto. | EP08 |
| TS-38    | Integración de Gemini API                      | Como developer, quiero conectar el backend con la API de Gemini usando la API Key para generar respuestas del chatbot M1AU. | **Escenario: Solicitud exitosa al modelo**<br>Dado que el backend envía una solicitud a Gemini con el mensaje del usuario<br>Cuando la API Key es válida<br>Entonces recibe una respuesta generada por el modelo.<br><br>**Escenario: Error por API Key inválida**<br>Dado que la API Key está expirada o incorrecta<br>Cuando Gemini rechaza la petición<br>Entonces se devuelve un error 401 al cliente. | EP08 |
| TS-39    | Controlador de filtros M1AU                   | Como developer, quiero un controlador que interprete intenciones (artista, fecha, ubicación, plataforma) y filtre conciertos desde la base de datos. | **Escenario: Filtrado por artista**<br>Dado que el usuario dice “Quiero conciertos de Bad Bunny”<br>Cuando el controlador detecta la intención<br>Entonces devuelve una lista filtrada por artista.<br><br>**Escenario: Filtrado por fecha**<br>Dado que el usuario consulta “Conciertos el 20 de diciembre”<br>Cuando la fecha es válida<br>Entonces devuelve los eventos correspondientes.<br><br>**Escenario: Filtrado por plataforma**<br>Dado que el usuario pide “Conciertos de Teleticket”<br>Entonces devuelve la lista filtrada por esa plataforma. | EP08 |
| TS-40    | Implementación UI del chatbot M1AU             | Como developer frontend, quiero integrar M1AU en GigMap para permitir conversar sin recargar la página. | **Escenario: Envío de mensaje**<br>Dado que el usuario escribe un mensaje<br>Cuando presiona “Enviar”<br>Entonces la UI envía un POST al backend y muestra la respuesta generada.<br><br>**Escenario: Conversación fluida**<br>Dado múltiples mensajes<br>Cuando el usuario sigue interactuando<br>Entonces la UI mantiene el historial visible y ordenado.<br><br>**Escenario: Error del servidor**<br>Dado una falla en la API<br>Entonces se muestra un mensaje de error amigable. | EP08 |

**Spike Stories:**
| Story ID | Título                                       | Descripción                                                                                                                                                                                                                         | Criterios de Aceptación                                                                                                                                                                                                                                                                                                                                                                             | Relacionado con (Epic ID) |
|----------|-----------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|
| SP-01    | Integración de mapa para conciertos          | Como miembro del equipo, quiero investigar las distintas APIs de mapas disponibles (como Google Maps, Mapbox y Leaflet) para identificar cuál se adapta mejor a las necesidades de la aplicación en cuanto a visualización de eventos en vivo. | - Comparar Google Maps, Mapbox y Leaflet en términos de facilidad de uso, precio y personalización. <br> - Validar capacidad de mostrar múltiples marcadores. <br> - Explorar funcionalidades como clustering y geofencing. <br> - Desarrollar un prototipo básico con eventos mockeados en el mapa.                                                                                                  | EP01                     |
...
| 84 | US42 | Acceso a un asistente conversacional | Como usuario de GigMap, quiero contar con un asistente virtual que me ayude a navegar y encontrar información rápidamente para mejorar mi experiencia. | 3 |
| 85 | US43 | Filtrar conciertos por artista mediante el chatbot | Como usuario, quiero poder escribirle a M1AU el nombre de un artista para que me muestre los conciertos disponibles de dicho artista. | 3 |
| 86 | US44 | Filtrar conciertos por fecha mediante el chatbot | Como usuario, quiero poder pedirle a M1AU conciertos para una fecha específica para encontrar eventos que coincidan con mis planes. | 3 |
| 87 | US45 | Filtrar conciertos por plataforma mediante el chatbot | Como usuario, quiero poder pedir conciertos según su plataforma de venta (como Teleticket o Joinnus) para ver solo los eventos de mi preferencia. | 2 |
| 88 | US46 | Comprensión de lenguaje natural | Como usuario, quiero que M1AU entienda frases naturales y no solo comandos específicos para conversar de forma más fluida. | 5 |
| 89 | US47 | Acceso rápido desde las respuestas del chatbot | Como usuario, quiero que M1AU incluya enlaces o botones a conciertos para acceder rápidamente al detalle del evento desde la conversación. | 2 |
| 90 | US48 | Respuestas rápidas y dinámicas | Como usuario, quiero que M1AU responda rápidamente para mantener una conversación fluida y eficiente. | 3 |
| 91 | TS-37 | Endpoint para enviar mensaje a M1AU | Como developer, quiero un endpoint POST /postchat que reciba el mensaje del usuario y devuelva la respuesta generada por el modelo. | 5 |
| 92 | TS-38 | Integración de Gemini API | Como developer, quiero conectar el backend con la API de Gemini usando la API Key para generar respuestas del chatbot M1AU. | 3 |
| 93 | TS-39 | Controlador de filtros M1AU | Como developer, quiero un controlador que interprete intenciones (artista, fecha, ubicación, plataforma) y filtre conciertos desde la base de datos. | 8 |
| 94 | TS-40 | Implementación UI del chatbot M1AU | Como developer frontend, quiero integrar M1AU en GigMap para permitir conversar sin recargar la página. | 5 |
...
<p align="center">
  <img src="assets/images/sprint-1/commints-landing.png" alt="Commits" width="800">
</p>
...
<p align="center">
  <img src="assets/images/sprint-1/commints-backend.png" alt="Commits" width="800">
</p>
...
<p align="center">
  <img src="assets/images/sprint-1/commints-frontend.png" alt="Commits" width="800">
</p>
...
<table border="1" cellpadding="5" cellspacing="0">
  ...
  <tr>
    <td>Sprint 2 Goal</td>
    <td>
Nuestro enfoque está en completar la totalidad de las funcionalidades principales de Gigmap desarrolladas en Jetpack Compose con Kotlin, lo que incluye la implementación del sistema de notificaciones, la integración y funcionamiento del chatbot M1AU basado en lenguaje natural, y el desarrollo de la primera versión operativa de la aplicación Gigmap en Flutter, incorporando las pantallas iniciales y la navegación básica. Este sprint se orienta a consolidar una versión temprana pero funcional del producto, unificando los avances técnicos del frontend, backend e inteligencia artificial en un único entregable coherente.

Creemos que esto generará un impacto significativo en la validación temprana del producto, permitiendo a los usuarios iniciales y al equipo de desarrollo evaluar la experiencia general de la aplicación, su flujo de interacción, la respuesta del sistema y la viabilidad de las funcionalidades clave. Asimismo, permitirá identificar mejoras, dependencias técnicas y prioridades para los siguientes sprints, fortaleciendo la madurez del proyecto y reduciendo riesgos de implementación.

Esto se confirmará cuando la versión en Jetpack Compose de Gigmap muestre todas sus funcionalidades centrales operativas, el sistema de notificaciones se active correctamente en los escenarios definidos, el chatbot M1AU procese y responda interacciones de acuerdo con los criterios de aceptación establecidos, y la versión inicial de Gigmap en Flutter cargue correctamente sus pantallas de inicio, permita la navegación básica y pueda ser evaluada de manera integrada como parte del Incremento del sprint.
</td>
  </tr>
  <tr>
...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: |
| US16 | Unirse a una comunidad | TK-01 | Implementar lógica de unión a comunidad | Como fan, quiero unirme a una comunidad musical para interactuar con otros usuarios con intereses similares. | 3 | Renato | Done |
| US17 | Publicar en la comunidad | TK-02 | Desarrollo de funcionalidad de creación de posts | Como fan, quiero crear publicaciones en la comunidad a la que me he unido, para compartir opiniones, fotos o recomendaciones con otros miembros. | 3 | Renato | Done |
| US18 | Editar perfil personal | TK-03 | Implementar edición de perfil (datos y foto) | Como fan, quiero poder editar mi información de perfil (foto, nombre y nombre de usuario), para que los demás usuarios puedan reconocerme fácilmente y mantener mi perfil actualizado. | 2 | Ariana | Done |
| US19 | Confirmar o marcar asistencia a un concierto | TK-04 | Desarrollo de toggle de asistencia a evento | Como fan, quiero poder marcar un concierto como “Marcar asistencia”, para llevar un seguimiento de los conciertos que planeo asistir. | 3 | Johanna | Done |
| US20 | Ver comunidades accedidas | TK-05 | Frontend: Mostrar lista de grupos unidos | Como usuario, quiero visualizar en el apartado "Tus grupos" las comunidades a las que me he unido. | 2 | Ariana | Done |
| US21 | Reaccionar a publicaciones en comunidades | TK-06 | Implementar reacciones (likes/emojis) a posts | Como usuario, quiero poder reaccionar a publicaciones dentro de las comunidades. | 2 | Diego | Done |
| US23 | Ver usuarios que asistirán a concierto | TK-07 | Frontend: Mostrar lista de asistentes a concierto | Como usuario, quiero ver qué otros usuarios asistirán al mismo concierto que yo. | 3 | Diego | Done |
| US24 | Acceder a perfil de otros usuarios | TK-08 | Implementar navegación a perfil público | Como usuario, quiero poder acceder al perfil de otros usuarios para conocer más sobre ellos. | 2 | Ariana | Done |
| US25 | Ver publicaciones con like | TK-09 | Desarrollo de vista de publicaciones favoritas | Como usuario, quiero ver una lista de publicaciones a las que les he dado "like". | 2 | Johanna | Done |
| US26 | Ver aplicaciones de venta del concierto | TK-10 | Frontend: Mostrar enlaces de venta en detalle concierto | Como usuario, quiero ver en qué aplicaciones puedo comprar entradas para un concierto. | 2 | JOhanna | Done |
| US29 | Ver miembros de comunidad | TK-11 | Frontend: Mostrar lista de miembros de comunidad | Como usuario, quiero ver la lista de miembros que pertenecen a una comunidad. | 2 | Renato | Done |
| US30 | Subir imágenes en comunidades | TK-12 | Implementación de carga de imágenes en posts | Como usuario, quiero subir imágenes en publicaciones de comunidad para compartir experiencias visuales. | 3 | Ariana | Done |
| US32 | Ver eventos asociados | TK-13 | Lógica de filtrado geo-temporal de eventos asociados | Como usuario de GigMap, quiero ver un apartado de eventos relacionados en el perfil de un concierto, para conocer actividades cercanas en tiempo y lugar. | 3 | Johanna | Done |
| US34 | Visualizar el contenido de las comunidades | TK-14 | Frontend: Feed de "Mis comunidades" | Como usuario, quiero poder visualizar las publicaciones y anuncios de las comunidades que sigo en la pantalla de “Mis comunidades”. | 2 | Mateo | Done |
| US35 | Recibir recordatorio de concierto por asistir | TK-15 | Implementar servicio de notificaciones programadas (24h) | Como usuario, quiero recibir la notificación de recordatorio del concierto al que confirme mi asistencia cuando la fecha de presentación esté cercana. | 5 | Diego | Done |
| US38 | Ver información detallada del evento asociado | TK-16 | Frontend: Vista de detalle de evento asociado | Como fan, quiero ver la información completa de un concierto para decidir si asistir. | 2 | Ariana | Done |
| US42 | Acceso a un asistente conversacional | TK-17 | Implementación básica de UI/UX de M1AU | Como usuario, quiero contar con un asistente virtual que me ayude a navegar y encontrar información rápidamente para mejorar mi experiencia. | 3 | Ariana | Done |
| US43 | Filtrar conciertos por artista mediante el chatbot | TK-18 | Lógica de filtrado por artista en M1AU | Como usuario, quiero poder escribirle a M1AU el nombre de un artista para que me muestre los conciertos disponibles de dicho artista. | 3 | Johanna | Done |
| US44 | Filtrar conciertos por fecha mediante el chatbot | TK-19 | Lógica de filtrado por fecha en M1AU | Como usuario, quiero poder pedirle a M1AU conciertos para una fecha específica para encontrar eventos que coincidan con mis planes. | 2 | Mateo | Done |
| US45 | Filtrar conciertos por plataforma mediante el chatbot | TK-20 | Lógica de filtrado por plataforma en M1AU | Como usuario, quiero poder pedir conciertos según su plataforma de venta para ver solo los eventos de mi preferencia. | 3 | Renato | Done |
| US46 | Comprensión de lenguaje natural | TK-21 | Entrenamiento y optimización de modelo NLP de M1AU | Como usuario, quiero que M1AU entienda frases naturales y no solo comandos específicos para conversar de forma más fluida. | 5 | Diego | Done |
| US47 | Acceso rápido desde las respuestas del chatbot | TK-22 | Implementar botones/links en respuestas de M1AU | Como usuario, quiero que M1AU incluya enlaces o botones a conciertos para acceder rápidamente al detalle del evento desde la conversación. | 2 | Johanna | Done |
| US48 | Respuestas rápidas y dinámicas | TK-23 | Optimización de rendimiento de M1AU (latencia < 2s) | Como usuario, quiero que M1AU responda rápidamente para mantener una conversación fluida y eficiente. | 3 | Mateo | Done |
| TS-37 | Endpoint para enviar mensaje a M1AU | TK-24 | Desarrollo de Endpoint POST /postchat | Como developer, quiero un endpoint POST /postchat que reciba el mensaje del usuario y devuelva la respuesta generada por el modelo. | 5 | Mateo | Done |
| TS-38 | Integración de Gemini API | TK-25 | Integración de backend con API de Gemini | Como developer, quiero conectar el backend con la API de Gemini usando la API Key para generar respuestas del chatbot M1AU. | 3 | Mateo | Done |
| TS-39 | Controlador de filtros M1AU | TK-26 | Desarrollo del controlador principal de intenciones y filtros | Como developer, quiero un controlador que interprete intenciones y filtre conciertos desde la base de datos. | 8 | Mateo | Done |
| TS-40 | Implementación UI del chatbot M1AU | TK-27 | Implementación de UI/UX de M1AU | Como developer frontend, quiero integrar M1AU en GigMap para permitir conversar sin recargar la página. | 5 | Mateo | Done |


#### 4.2.2.3. Development Evidence for Sprint Review

Evidencia de commits Landing page Versión 2:

| **Repository** | **Branch** | **Commit ID** | **Commit Message** | **Commit Message Body** | **Committed on (Date)** |
| :---: | :---: | :---: | :---: | :---: | :---: |
| GigMap-LandingPage-V2 | main | 5aad27e | feat(root): Primer commit | - | Nov 13, 2025 |
| GigMap-LandingPage-V2 | main | ae3d642 | Initial commit | - | Nov 13, 2025 |

Evidencia de commits Backend:

| **Repository** | **Branch** | **Commit ID** | **Commit Message** | **Commit Message Body** | **Committed on (Date)** |
| :---: | :---: | :---: | :---: | :---: | :---: |
| GigMap-Api | master | 4c9f0ea | docs: add JWT authentication documentation and quick start guides fed | - | Nov 10, 2025 |
| GigMap-Api | master | eb69b79 | fix(Dockerfile): Se corrigió el Dockerfile | - | Nov 9, 2025 |
| GigMap-Api | master | 63f7632 | feat(communities): Se añadió GetAllCommunitiesJoinedByUserId | - | Nov 9, 2025 |
| GigMap-Api | master | 9f5104d | feat(concerts): Se añadió GetAllConcertsAttendedByUserId | - | Nov 9, 2025 |
| GigMap-Api | master | fce696b | fix(communities): Se corrigió PostsController.java | - | Oct 24, 2025 |
| GigMap-Api | master | b259b36 | feat(communities): Se agregó GetAllLikedPostsByUserIdQuery.java | - | Oct 24, 2025 |
| GigMap-Api | master | ca045ff | fix(notifications): Se corrigió el NotificationsContextFacade.java | - | Oct 23, 2025 |
| GigMap-Api | master | 209d632 | fix(communities): Se corrigió el Post.java | - | Oct 23, 2025 |
| GigMap-Api | master | c9b81f9 | fix(communities): Se corrigió el PostCreatedEvent.java | - | Oct 23, 2025 |
| GigMap-Api | master | 66f78f1 | fix(notifications): Se corrigió el FirebaseConfig.java | - | Oct 22, 2025 |
| GigMap-Api | master | 6383daa | feat(communities): Se añadió PostCreatedEventHandler.java | - | Oct 22, 2025 |
...
- Finalización de la aplicación móvil desarrollada con Jetpack Compose, logrando una versión estable y completamente funcional, con sus vistas principales operativas y listas para pruebas de integración.

- Desarrollo de M1AU, un modelo de lenguaje natural (chatbot) diseñado para interactuar con los usuarios y proporcionar asistencia dentro de la plataforma. Se construyó una primera versión funcional que responde consultas básicas y mejora la experiencia interactiva.

- Corrección de observaciones realizadas durante el sprint previo, optimizando tanto el código como la estructura del proyecto, garantizando un funcionamiento más consistente y ordenado.

- Rediseño de la landing page, incorporando una interfaz visual más moderna y alineada con la identidad de GigMap. El nuevo diseño fue implementado y desplegado nuevamente en Render.

- Ampliación del backend, añadiendo nuevos endpoints para mejorar la comunicación con la aplicación móvil y soportar funcionalidades adicionales relacionadas con usuarios, comunidades, conciertos y notificaciones.

- Inicio del desarrollo de la aplicación en Flutter, logrando las primeras pantallas de inicio y estructurando la base del proyecto multiplataforma.
...
- El proyecto GigMap se consolida como una propuesta tecnológica y cultural orientada a transformar la manera en que las personas descubren, comparten y disfrutan la música en vivo. A lo largo de este entregable, se concretaron avances clave en las áreas de diseño, desarrollo e integración del sistema, marcando un hito importante en la evolución del producto. Se elaboraron los diseños en Figma de la aplicación y la landing page, cuidando la coherencia visual, la experiencia del usuario y la identidad de la marca. Además, se implementó el backend real con los endpoints esenciales para los módulos de artistas, comunidades, conciertos y eventos relacionados, junto con la incorporación de un mapa interactivo que facilita la exploración geográfica de eventos musicales.
